...
mkdir stats_setup/$test_name

echo "HOST-SETUP: Started!"

sudo -u root sshpass -p 1234 ssh 192.168.122.190 "cd /home/vm1/experiments/; bash setup.sh $test_name $experiment_type;"
