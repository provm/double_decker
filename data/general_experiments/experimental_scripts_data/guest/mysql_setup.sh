...
echo 125 > /sys/fs/cgroup/blkio/lxc/client4/blkio.weight
...
echo 10-13 >  /sys/fs/cgroup/cpuset/lxc/client4/cpuset.cpus
...
sudo -u root sshpass -p synerg ssh 10.129.28.78 "cd /home/synerg/prashanth/experiment/; helper_scripts/mysql_logger.sh $poolid_1 $poolid_2 $poolid_3 $poolid_4 $dir $exp" &

# Start logger
bash helper_scripts/mysql_logger.sh $dir $exp &

sudo -u root sshpass -p ubuntu ssh ubuntu@10.0.3.217 "cd oltp; ./oltpbenchmark -b ycsb -c /home/ubuntu/oltp/config/sample_ycsb_config.xml --execute=true" >> $exp/$dir/app/c4.out 2>&1
