...
#echo 1G > /sys/fs/cgroup/memory/lxc/c1/memory.limit_in_bytes
...
echo 1050 > /sys/fs/cgroup/memory/lxc/c1/hcache_weight
echo 1050 > /sys/fs/cgroup/memory/lxc/c3/hcache_weight
...
sudo -u vm1 sshpass -p ubuntu ssh ubuntu@10.0.3.48 /home/ubuntu/ycsb/bin/ycsb run mongodb -s -P /home/ubuntu/ycsb/workloads/workload1 -p mongodb.url=mongodb://10.0.3.220:27017/ycsb?w=0 -p "maxexecutiontime=600" &
