...
echo 125 > /sys/fs/cgroup/blkio/lxc/client3/blkio.weight
...
# Start workloads
#sudo -u vm1 sshpass -p ubuntu ssh ubuntu@10.0.3.48 /home/ubuntu/ycsb/bin/ycsb run mongodb -s -P /home/ubuntu/ycsb/workloads/workload1 -p mongodb.url=mongodb://10.0.3.220:27017/ycsb?w=0 -p "maxexecutiontime=1500" >> $exp/$dir/app/c1.out 2>&1
...
sudo -u root sshpass -p synerg ssh 10.129.28.78 "cd /home/synerg/prashanth/experiment/; helper_scripts/redis_logger.sh $poolid_1 $poolid_2 $poolid_3 $poolid_4 $dir $exp" &

# Start logger
bash helper_scripts/redis_logger.sh $dir $exp &

sudo -u vm1 sshpass -p ubuntu ssh ubuntu@10.0.3.25 /home/ubuntu/ycsb/bin/ycsb run redis -s -P /home/ubuntu/ycsb/workloads/workload1 -p "redis.host=10.0.3.168" -p "redis.port=6379" -p "operationcount=100000000" -p "maxexecutiontime=60">> $exp/$dir/app/c3.out 2>&1 
